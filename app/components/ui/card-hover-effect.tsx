    ...
    >
      {items.map((item, idx) => (
        <Link
          href={item?.link}
          key={item?.link}
          className="relative group border-white block p-2 h-full w-full"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl w-[300px] h-[200px] p-4 overflow-hidden bg-black border border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
